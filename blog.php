...
to add .php to the files when refering them because it goes to the directory if not, which is stupid -->
    ...
    <!-- Searchbar ended its div well -->
            ...
            <div class="segment-top">
                ...
                <h2 style="color: gray !important; padding-top: 30px; text-align: center; ">BLOG</h2>
                <p></p>
            </div>
