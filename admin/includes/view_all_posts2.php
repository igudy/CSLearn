...
<a class="btn btn-warning" href="posts">Posts</a>
...
<!--        <th>Author</th> -->
    ...
    <tbody>
        ...
        while($row = mysqli_fetch_assoc($select_all_posts)){
            ...
            echo "<td><img width='100' height='150' src='../threads/....' alt='thread image'></td>";
            }
            else{
                continue;
            }
            ...
            if(($post_image_thread1 || $post_image_thread2 || $post_image_thread3) == true){    
                echo "<td><img width='100' height='150' src='../images/threads/$post_image_thread1' alt='image'></td>";
                echo "<td><img width='100' height='150' src='../images/threads/$post_image_thread2' alt='image'></td>";
                echo "<td><img width='100' height='150' src='../images/threads/$post_image_thread3' alt='image'></td>";
            }
            else{
                echo "<td>N/a</td>";
                echo "<td>N/a</td>";
...
if(isset($_GET['delete'])){
    ...
    header("location: posts?source=view_all_posts2.php");
}
